<template>
  <section class="contact-info py-0 px-0 px-0-md px-0-lg px-5-xl py-5">
    <div class="row px-3 px-3-sm px-5-md px-5-lg px-0-xl pb-4">
      <div class="">
        <h1 class="contact-title">How to reach us</h1>
        <p class="contact-subtitle">Lorem ipsum dolor sit amet, consetetur.</p>
      </div>
    </div>
    <div class="contact-container">
      <div class="contact-content px-3 px-3-sm px-5-md px-5-lg px-0-xl">
        <form @submit.prevent="submitForm" class="contact-form">
          <div class="form-row">
            <div class="form-group">
              ...
              <input
                ...
                :class="{ error: errors.firstName && submitted }"
                required
              />
            ...
            <div class="form-group">
              ...
              <input
                ...
                :class="{ error: errors.lastName && submitted }"
                required
              />
          ...
          <div class="form-group">
            ...
            <input
              ...
              :class="{ error: errors.email && submitted }"
              required
            />
          ...
          <div class="form-group checkbox-group">
            ...
            <Checkbox
              ...
              v-model="formData.termsAccepted"
              :class="{ error: errors.terms && submitted }"
            >I agree to the <a href="#" class="terms-link">Terms & Conditions</a></Checkbox>
          </div>
<div >
      ...
      <div class="map-container">
        <div class="mapouter">
          <div class="gmap_canvas">
            <!-- Updated iframe URL with explicit marker parameters -->
            <iframe
